...
const PlantCard = (objekat) => {
  const [izbrisan, setIzbirsan] = useState(false);
  const handleCardClose = () => {
    axios
      .delete(`http://localhost:3500/deletePlant`, {
        params: { id: objekat?.plant?._id },
      })
      .then((response) => {
      ...
      <div className="kutija">
        <div className="card" style={{ height: "auto", position: "relative" }}>
          <svg
            ...
            onClick={() => objekat.handleId(objekat.plant)}
          >
            <path
