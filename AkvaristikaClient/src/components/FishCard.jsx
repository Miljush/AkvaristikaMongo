...
const FishCard = (objekat) => {
  const [izbrisan, setIzbirsan] = useState(false);
  const handleCardClose = () => {
    axios
      .delete(`http://localhost:3500/deleteFish`, {
        params: { id: objekat?.fish?._id },
      })
      .then((response) => {
      ...
      <div className="kutija">
        <div className="card" style={{ height: "auto", position: "relative" }}>
          <svg
            ...
            onClick={() => objekat.handleId(objekat.fish)}
          >
            <path
